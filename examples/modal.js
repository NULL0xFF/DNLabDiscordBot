...
app.post('/interactions', function (req, res) {
  ...
  if (type === InteractionType.APPLICATION_COMMAND) {
    ...
    if (data.name === 'test') {
      ...
      return res.send({
        type: InteractionResponseType.APPLICATION_MODAL, data: {
          custom_id: 'my_modal', title: 'Modal title', components: [{
            // Text inputs must be inside an action component
            ...
            type: MessageComponentTypes.ACTION_ROW, components: [{
              type: MessageComponentTypes.INPUT_TEXT,
              custom_id: 'my_longer_text', // Bigger text box for input
              style: 2,
